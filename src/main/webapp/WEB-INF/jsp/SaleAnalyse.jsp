    ...
    <div id="page-wrapper">
        ...
        <div class="container">
            <div class="row hero" style="padding-top: 30px; padding-bottom: 0px;">
                <a class="btn btn-primary" target="_blank" href="${pageContext.request.contextPath}/salePie">查看销量占比</a>
                <div class="row hero" style="padding-top: 30px; padding-bottom: 0px;">
                    ...
                    <div class="col-sm-10 push-sm-1 later" style="font-size: 14px;">
                        ...
                        <div id="chart-aggr" class="border" style="width: 970px;border: 0;"></div>
                    </div>
                </div>
            </div>
        </div>
